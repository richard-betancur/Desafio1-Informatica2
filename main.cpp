    ...
    while (opcion != 0)
    {
        ...
        if (opcion == 1)
        {
            ...
            while (cin.fail() || fila < 0 || fila >= filas)
            {
                ...
                cout << "Fila invalida. Ingrese una fila entre 0 y "
                     << filas - 1 << ": ";
            ...
            while (cin.fail() || columna < 0 || columna >= columnas)
            {
                ...
                cout << "Columna invalida. Ingrese una columna entre 0 y "
                     << columnas - 1 << ": ";

                cin >> columna;
            }

            eliminarFichaJugador(
                datos,
                filas,
                columnas,
                fila,
            ...
            int cantidadCascadas = procesarCascadas(
                datos,
                filas,
                columnas,
                marcas,
            ...
            cout << "Eliminaciones del jugador: "
                 << eliminacionesJugador
                 << endl;
        }
        ...
        else if (opcion == 2)
        {
            ...
            while (cin.fail() || posicion < 0 || posicion > filas)
            {
                ...
                cout << "Posicion invalida. Ingrese una posicion entre 0 y "
                     << filas << ": ";
